...
export default function Step1SignUp() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      {/* Left side - image */}
      <div className="hidden lg:block lg:w-[40%] relative bg-surface">
        <div className="absolute inset-0">
          <div className="w-full h-full flex items-center justify-center">
            <div className="w-4/5 h-4/5 bg-gradient-to-br from-sky-200 to-sky-400 flex items-end justify-center overflow-hidden">
              <div className="w-3/4 h-3/4 bg-gradient-to-t from-amber-100 to-amber-200" />
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Right side - form */}
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-10 lg:py-12">
        <div className="w-full max-w-[460px]">
          ...
          <div className="flex gap-2 mb-5">
            <button
              type="button"
              className="flex-1 flex items-center justify-center gap-3 bg-[#0077B5] text-white py-3 px-4 font-medium hover:bg-[#006399] transition-colors text-sm"
            >
            ...
            <button
              type="button"
              className="w-12 h-12 flex items-center justify-center border border-border hover:bg-surface transition-colors shrink-0"
            >
